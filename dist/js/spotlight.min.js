...
function Oa(){var a=G;K=L[a-1];N=K.firstElementChild;G=a;if(!N){var b="false"!==I.preloader,c=U[a-1];c.src.match(/https:\/\/www.youtube.com\/embed/)?K.appendChild(c.element.cloneNode(!0)):(N=new Image,N.onload=function(){b&&h(Q,"show");U&&(y=this.width,z=this.height,k(this,{visibility:"visible",opacity:1,transform:""}),"false"!==I.prefetch&&a<H&&((new Image).src=U[a].src))},N.onerror=function(){K.removeChild(this)},K.appendChild(N),N.src=c.src);b&&f(Q,"show");return!b}return!0}la(document,"",Pa);
la(document,"DOMContentLoaded",Qa,{once:!0});var Ra=!1;
...
{opacity:d?0:1,transform:"translate(-50%, -50%)"+(c?" scale(0.8)":"")+(w&&"undefined"!==typeof a?" rotateY("+(a?"":"-")+"90deg)":""),maxHeight:"",maxWidth:""});e&&k(N,{visibility:"visible",opacity:1,transform:""});x&&h(N,x);X();k(za,"visibility",J||1!==G?"":"hidden");k(Ba,"visibility",J||G!==H?"":"hidden");a=U[G-1];if(c=(c=a.title||a.description)&&"false"!==c)ka(xa,a.title||""),ka(ya,a.description||"");k(wa,"visibility",c?"visible":"hidden");ka(Ca,G+" / "+H);ta&&ta(G)}
